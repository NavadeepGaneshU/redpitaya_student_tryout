...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  design_1_jc2_0_0 jc2_0
       (.clk(Clock_Divider_0_clock_out),
        .goLeft(left_Dout),
        .goRight(right_Dout),
        .q(jc2_0_q),
        .stop(stop_Dout));
  design_1_xlslice_0_0 left
  ...
  design_1_xlslice_0_1 right
       (.Din(processing_system7_0_GPIO_O[31:0]),
        .Dout(right_Dout));
  design_1_xlslice_0_2 stop
       (.Din(processing_system7_0_GPIO_O[31:0]),
        .Dout(stop_Dout));
endmodule
